...
begin
    ...
    adder_4: component adder generic map (N) port map (sum_0, sum_1, sum_4);
    adder_5: component adder generic map (N) port map (sum_2, sum_3, sum_5);
    
    adder_6: component adder generic map (N) port map (sum_4, sum_5, out_0);
