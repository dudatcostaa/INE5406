...
entity transform_1d_8inputs is
    ...
    port(
        in_0, in_1, in_2, in_3, in_4, in_5, in_6, in_7: in signed(N downto 0);
        out_0, out_1, out_2, out_3, out_4, out_5, out_6, out_7: out signed(N+3 downto 0)
    );
end entity transform_1d_8inputs;

architecture arch of transform_1d_8inputs is
    signal wire_0_0, wire_0_1, wire_0_2, wire_0_3, wire_0_4, wire_0_5, wire_0_6, wire_0_7: signed(N+1 downto 0);
    signal wire_1_0, wire_1_1, wire_1_2, wire_1_3, wire_1_4, wire_1_5, wire_1_6, wire_1_7: signed(N+2 downto 0);
...
begin
    -- layer 0 (first)
    butterfly2_0_0: component butterfly2 generic map (N => N+1) port map (in_0, in_1, wire_0_0, wire_0_1);
    butterfly2_0_1: component butterfly2 generic map (N => N+1) port map (in_2, in_3, wire_0_2, wire_0_3);
    butterfly2_0_2: component butterfly2 generic map (N => N+1) port map (in_4, in_5, wire_0_4, wire_0_5);
